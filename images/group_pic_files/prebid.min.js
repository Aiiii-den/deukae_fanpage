...
"use strict";(self.pbjsChunk=self.pbjsChunk||[]).push([[188],{475:function(e,t,n){var r=n(853),o=n(125),i=n(849);function s(e){return s="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},s(e)}var a="concert",d={code:a,isBidRequestValid:function(e){return!!e.params.partnerId||((0,r.yN)("Missing partnerId bid parameter"),!1)},buildRequests:function(e,t){(0,r.ji)(e),(0,r.ji)(t);var n={meta:{prebidVersion:"6.25.0",pageUrl:t.refererInfo.referer,screen:[window.screen.width,window.screen.height].join("x"),debug:(0,r.eB)(),uid:p(t),optedOut:u(),adapterVersion:"1.1.1",uspConsent:t.uspConsent,gdprConsent:t.gdprConsent}};return n.slots=e.map((function(e){return{name:e.adUnitCode,bidId:e.bidId,transactionId:e.transactionId,sizes:e.params.sizes||e.sizes,partnerId:e.params.partnerId,slotType:e.params.slotType,adSlot:e.params.slot||e.adUnitCode,placementId:e.params.placementId||"",site:e.params.site||t.refererInfo.referer}})),(0,r.ji)(n),{method:"POST",url:"".concat("https://bids.concert.io","/bids/prebid"),data:JSON.stringify(n)}},interpretResponse:function(e,t){(0,r.ji)(e),(0,r.ji)(t);var n,o=e.body;return o&&"object"===s(o)?(n=o.bids.map((function(e){return{requestId:e.bidId,cpm:e.cpm,width:e.width,height:e.height,ad:e.ad,ttl:e.ttl,meta:{advertiserDomains:e&&e.adomain?e.adomain:[]},creativeId:e.creativeId,netRevenue:e.netRevenue,currency:e.currency}})),(0,r.eB)()&&o.debug&&(0,r.ji)("CONCERT",o.debug),(0,r.ji)(n),n):[]},getUserSyncs:function(e,t,n,r){var o=[];if(e.iframeEnabled&&!u()){var i=[];n&&"boolean"==typeof n.gdprApplies&&i.push("gdpr_applies=".concat(n.gdprApplies?"1":"0")),n&&"string"==typeof n.consentString&&i.push("gdpr_consent=".concat(n.consentString)),r&&"string"==typeof r&&i.push("usp_consent=".concat(r)),o.push({type:"iframe",url:"https://cdn.concert.io/lib/bids/sync.html"+(i.length>0?"?".concat(i.join("&")):"")})}return o},onTimeout:function(e){(0,r.ji)("concert bidder timed out"),(0,r.ji)(e)},onBidWon:function(e){(0,r.ji)("concert bidder won bid"),(0,r.ji)(e)}};(0,o.dX)(d);var c=(0,i.df)({bidderCode:a});function p(e){if(u()||!function(e){return!("string"===e.uspConsent&&"1YY"===e.uspConsent.toUpperCase().substring(0,2))}(e))return!1;var t="c_uid",n=c.getDataFromLocalStorage(t);return n||(n=(0,r.DO)(),c.setDataInLocalStorage(t,n)),n}function u(){return"true"===c.getDataFromLocalStorage("c_nap")}window.pbjs.installedModules.push("concertBidAdapter")}},function(e){e(e.s=475)}]);
